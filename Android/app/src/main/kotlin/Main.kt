...
internal val logger: SkipLogger = SkipLogger(subsystem = "fair.skies", category = "FairSkies")

private typealias AppRootView = FairSkiesRootView
private typealias AppDelegate = FairSkiesAppDelegate
